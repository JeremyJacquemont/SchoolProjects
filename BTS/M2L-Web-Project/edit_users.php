...
function freeze_panes_table_html($info, $columns, $class, $action=FALSE)
{
  ...
  foreach ($info as $line)
  {
    ...
    if ($action)
    {
      ...
      {
        $html .= "<form method=\"post\" action=\"edit_users\">\n";
        $html .= "<div>\n";
...
if (isset($Action) && ( ($Action == "Edit") or ($Action == "Add") ))
{
  ...
  print "<form id=\"form_edit_users\" method=\"post\" action=\"edit_users\">\n";
    ?>
      ...
      {
        echo "<form id=\"form_delete_users\" method=\"post\" action=\"edit_users\">\n";
        echo "<div>\n";
...
if (isset($Action) && ($Action == "Update"))
{
  ...
  else
  {
    ...
    if (!$valid_data)
    { 
      Header("Location: edit_users/$q_string");
      exit;
    }
    ...
    if ($r == -1)
    {
      ...
      print "<form class=\"edit_users_error\" method=\"post\" action=\"edit_users\">\n";
      print "  <fieldset>\n";
      print "  <legend></legend>\n";
...
{
  print "<form id=\"add_new_user\" method=\"post\" action=\"edit_users\">\n";
  print "  <div>\n";
