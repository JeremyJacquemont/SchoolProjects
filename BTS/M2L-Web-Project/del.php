...
if ($type == "room")
{
  ...
  else
  {
    ...
    echo "<a href=\"del/area:$area-room:$room-type:room-confirm:Y\"><span id=\"del_yes\">" . get_vocab("YES") . "!</span></a>\n";
    echo "<a href=\"admin\"><span id=\"del_no\">" . get_vocab("NO") . "!</span></a>\n";
    echo "</div>\n";
    echo "</div>\n";
...
if ($type == "area")
{
  ...
  else
  {
    ...
    echo "<a href=\"admin\">" . get_vocab("backadmin") . "</a>";
    echo "</p>\n";
    require_once "trailer.inc";
  }
}
