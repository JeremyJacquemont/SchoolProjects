...
<div id="site_faq_contents">
  ...
  <ul>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#authenticate">How do I login?</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#meeting_delete">Why can't I delete/alter a meeting?</a></li>
  </ul>
  
  <h4>Making/Altering Meetings</h4>
  <ul>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#repeating">How do I make a recurring meeting?</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#repeating_delete">How do I delete one instance of a recurring meeting?</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#multiple_sites">How do I schedule rooms at different sites?</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#too_many">My meeting failed to be created because of <q>too many entries</q>!</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#multiple_users">What happens if multiple people schedule the same meeting?</a></li>
  </ul>
  
  <h4>Miscellaneous</h4>
  <ul>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#internal_external">What is the difference between <q>Internal</q> and <q>External</q>?</a></li>
  </ul>
  
  <h4>About The Meeting Room Booking System</h4>
  <ul>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#how_much">How much did the system cost?</a></li>
    <li><a href="<?php echo $_SERVER[REQUEST_URI]; ?>#about">How does the system work and who wrote it?</a></li>
  </ul>
</div>
