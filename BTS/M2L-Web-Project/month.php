...
echo make_area_select_html('month', $area, $year, $month, $day);  
  ...
  {   
    ...
    if (isset($d[$cday]["id"][0]))
    {
      ...
      for ($i = 0; $i < $n; $i++)
      {
        ...
        $url = formatURLDate($year, $month, $cday);
        $booking_link = "view_entry/id:" . $d[$cday]["id"][$i] . "/$url";
