...
if(isset($_POST) && $_POST['afficher'] != null && $_POST['afficher'] == "ok")
{
    $year = $_POST['year']; $month = $_POST['month']; $day = $_POST['day']; $area = $_POST['area'];
    $url = "$year-$month-$day/area:$area";
...
else
{
  ...
  else
  {
    ...
    echo "<form id=\"areaChangeForm\" method=\"post\" action=\"admin\">\n";
    echo "<fieldset>\n";
    echo "<legend></legend>\n";
