...
if(isset($_GET) && $_GET['afficher'] != null && $_GET['afficher'] == "ok" && $_GET['search_str'] != "")
{
    $year = $_GET['from_year']; $month = $_GET['from_month']; $day = $_GET['from_day']; $str = $_GET['search_str'];
    $url = "$year-$month-$day/search_str:$str";
...
if ($has_prev || $has_next)
{
  ...
  if($has_prev)
  {
    $query_string = formatURLSearch($year, $month, $day, $search_str, $total, max(0, $search_pos-$search["count"])) ;
    echo "<a href=\"search/$query_string\">";
  }
